...
const Capturados = () => {
  ...
  return (
    <div className='pokemonesCapturados'>
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {pokedex.filter((pokemon) => pokemon.capturado === true).map((pokemon) => (
          <li
            key={pokemon.id}
            className="bg-yellow-400 shadow-md rounded-2xl p-4 flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-xl"
          >
            <img
